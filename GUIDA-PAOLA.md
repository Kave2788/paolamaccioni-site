...
Guida rapida per Paola. Tieni questo foglio vicino al computer.

---

## Per caricare nuove foto

1. **Doppio-click** sull'icona **"Avvia Pannello"** (sul Desktop).
2. Si apre una **finestra nera**: lasciala aperta, non chiuderla.
3. Dopo qualche secondo si apre **da solo il browser** con il pannello.
4. Nel pannello:
   - Premi **"+ Nuova opera"** (a sinistra)
   - Scrivi il **titolo**, scegli la **serie**, l'**anno**
   - **Trascina le foto** nel riquadro (o clicca per sceglierle)
   - La prima foto è quella principale — puoi cambiarla cliccandoci sopra
   - Premi **"Carica opera →"**
...
6. Quando hai **finito di caricare tutto**, premi il pulsante grande
   **"↑ Pubblica sul sito"** (in basso a sinistra).
7. Compare il messaggio **"Sito aggiornato!"**.
8. Aspetta **circa un minuto**: le foto sono online su paolamaccioni.com.

## Quando hai finito

9. Chiudi il browser.
10. Chiudi la **finestra nera**.

---

## Cose importanti

- **Carica tutto e poi pubblica una volta sola.** Non serve premere "Pubblica"
...
*In caso di dubbi, chiama Andrea.*
